      ...
      <section className={styles.hero}>
        ...
        >
          ...
          <p className={styles.heroSubtitle}>
            Have questions about your dental journey? We're here to help.
          </p>
        </motion.div>
      </section>
      ...
      <section className={styles.content}>
        <div className={styles.grid}>
          ...
          >
            ...
            <a href="tel:+919030991859" className={styles.cardLink}>
              +91 90309 91859
            </a>
            <p className={styles.cardDetail}>
          ...
          >
            ...
            <a href="mailto:contact@atidinricare.com" className={styles.cardLink}>
              contact@atidinricare.com
            </a>
            <p className={styles.cardDetail}>
